...
import { ChevronLeft, Cpu, DollarSign, LayoutGrid, Loader2, Package, Save } from "lucide-react";
          ...
          <div className="grid auto-rows-max items-start gap-6 lg:col-span-2">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-3">
                ...
                {/* TÍCH HỢP MÁY TÍNH IN 3D ĐỒNG BỘ MÃ GIẢM GIÁ & MÃ NHỰA THẬT */}
              ...
              <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                ...
                {price > 0 && costPrice > 0 && (
                  <div className="col-span-full rounded-lg bg-muted/60 p-3 text-xs flex justify-between items-center border">
                    <span className="text-muted-foreground">Biên lợi nhuận ròng dự kiến (dựa trên giá sau giảm):</span>
