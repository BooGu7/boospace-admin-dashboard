...
export default async function Page() {
  ...
  // Lấy dữ liệu tài chính thật từ Supabase
        ...
        <TabsContent value="30-days" className="flex flex-col gap-4">
          <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
            <div className="xl:col-span-6">
              {/* TRUYỀN DỮ LIỆU VÀO CARD KPIS */}
              <OverviewKpis stats={stats} />
            </div>

            <div className="flex flex-col gap-4 xl:col-span-6">
              {/* TRUYỀN BIỂU ĐỒ TRÒN DANH MỤC */}
          ...
          <div className="grid grid-cols-1 gap-4 xl:grid-cols-12">
            <div className="xl:col-span-7">
              {/* TRUYỀN DANH SÁCH ĐƠN HÀNG GẦN ĐÂY VÀO BẢNG GIAO DỊCH */}
              <TransactionsOverviewCard orders={stats.recentOrders} />
            </div>
            <div className="xl:col-span-5">
              <BalanceDistributionCard stats={stats} />
            </div>
          </div>
